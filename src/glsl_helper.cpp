...
namespace glsl_helper
{
	std::array<float, 256 * 4> colours{
		...
		0.0314f, 1.0000f, 1.0000f, 1.0000f, // 9
		0.0353f, 1.0000f, 1.0000f, 1.0000f, // 10
		0.0392f, 1.0000f, 1.0000f, 1.0000f, // 11
		0.0431f, 1.0000f, 1.0000f, 1.0000f, // 12
		0.0471f, 1.0000f, 1.0000f, 1.0000f, // 13
		0.0510f, 1.0000f, 1.0000f, 1.0000f, // 14
		0.0549f, 1.0000f, 1.0000f, 1.0000f, // 15
		0.0588f, 1.0000f, 1.0000f, 1.0000f, // 16
		0.0627f, 1.0000f, 1.0000f, 1.0000f, // 17
		0.0667f, 1.0000f, 1.0000f, 1.0000f, // 18
		0.0706f, 1.0000f, 1.0000f, 1.0000f, // 19
		0.0745f, 1.0000f, 1.0000f, 1.0000f, // 20
		0.0784f, 1.0000f, 1.0000f, 1.0000f, // 21
		0.0824f, 1.0000f, 1.0000f, 1.0000f, // 22
		0.0863f, 1.0000f, 1.0000f, 1.0000f, // 23
		0.0902f, 1.0000f, 1.0000f, 1.0000f, // 24
		0.0941f, 1.0000f, 1.0000f, 1.0000f, // 25
		0.0980f, 1.0000f, 1.0000f, 1.0000f, // 26
		0.1020f, 1.0000f, 1.0000f, 1.0000f, // 27
		0.1059f, 1.0000f, 1.0000f, 1.0000f, // 28
		0.1098f, 1.0000f, 1.0000f, 1.0000f, // 29
		0.1137f, 1.0000f, 1.0000f, 1.0000f, // 30
		0.1176f, 1.0000f, 1.0000f, 1.0000f, // 31
		0.0100f, 0.0100f, 0.9800f, 0.7500f, // 32: WATER
		1.0000f, 0.5500f, 0.1000f, 1.0000f, // 33: LAVA
		0.0333f, 1.0000f, 0.0333f, 0.7000f, // 34: ACID
		0.1373f, 1.0000f, 1.0000f, 1.0000f, // 35: HONEY
		0.8412f, 0.9000f, 1.0000f, 0.7500f, // 36: LIQUID_GLASS
		...
		0.9000f, 0.9000f, 1.0000f, 0.9000f, // 64: GLASS
		...
		0.9000f, 0.9000f, 0.9100f, 1.0000f, // 77: TEMPORARY_SNOW
		0.9059f, 0.9000f, 1.0000f, 0.9000f, // 78: ICE
		0.8500f, 0.8000f, 0.8000f, 1.0000f, // 79: ASH
		0.3137f, 0.3137f, 0.3137f, 1.0000f, // 80: CONVEYOR_BELT
		0.4176f, 0.4176f, 0.4176f, 1.0000f, // 81: CONVEYOR_TOOTH
		0.9000f, 0.7600f, 0.7600f, 1.0000f, // 82: INSULATION
		0.7216f, 0.5000f, 0.5000f, 1.0000f, // 83: INSULATION_FOAM
		0.1294f, 0.1500f, 0.1000f, 1.0000f, // 84: CHARCOAL
		1.0000f, 0.4352f, 0.2000f, 1.0000f, // 85: LIGHT_EMBER
